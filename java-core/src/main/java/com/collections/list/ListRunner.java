...
//        ToDoList list = new ToDoList();
        ToDoLinkedList list = new ToDoLinkedList();
        ...
        while (param != 0) {
            switch (param) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.println("Please enter a task to add Alphabetical Order");
                    scanner.nextLine();
                    String task7 = scanner.nextLine();
                    list.addInAlphabeticalOrder(task7);
                    System.out.println("Please choose an action by typing [0-6]");
                    param = scanner.nextInt();
                    break;
                default:
    ...
    private static void printOut() {
        System.out.println("Please choose an action. Press :\n"
                ...
                + "7 to add a new item into ToDoList Alphabetical Order\n"
                + "press 0 for exit\n\n"
