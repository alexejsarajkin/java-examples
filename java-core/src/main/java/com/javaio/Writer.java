...
import com.collections.map.treemap.AverageStudentGrade;
import com.collections.map.treemap.SubjectGrade;
...
public class Writer {
    ...
    public void nioWriteWithChannel(String fileName) throws IOException {
        String str = "You can also create a new file by using the newOutputStream com.methods," +
