...
public class LambdaFunctionExample {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee("Alex", "Black", 50000, "IT"));
        employees.add(new Employee("John", "Green", 75000, "IT"));
        employees.add(new Employee("Sam", "Brown", 80000, "IT"));
        employees.add(new Employee("Tony", "Grey", 90000, "IT"));
