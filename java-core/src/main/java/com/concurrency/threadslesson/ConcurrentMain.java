package com.concurrency.threadslesson;
    ...
    public void run() {
        ...
        for (int i = 0; i < 10; i++) {
            try {
                ...
                System.out.println(ColorScheme.YELLOW + "WARN - " + currentThread().getName() + " was interrupted ");
                return;
            }
    ...
    public void run() {
        for (int i = 0; i < 10; i++) {
            try {
                ...
                System.out.println(ColorScheme.YELLOW + "WARN - " + Thread.currentThread().getName() + " was interrupted ");
            }
