    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        IntStream.range(0, customers)
                .forEach(client -> executorService.submit(() -> {
                    ...
                    System.out.println(ColorScheme.GREEN + "Number of connected customers " + serviceDesk.getCustomersConnected());
                    System.out.println(ColorScheme.RED + "Number of customers in a queue " + serviceDesk.getCustomersWaiting());
